...
<div class="container">	
		<div class="text-center"><h3>제품 등록</h3></div>
		<form action="<c:url value='/admin/proAddEx'/>" method="post" enctype="multipart/form-data">
		...
		<div class="mb-3" style="width: 20%; float:none; margin:0 auto">
			...
			<input type="text" name="proMaker" id="proMaker" class="form-control">
		</div>
		<div class="mb-3" style="width: 20%; float:none; margin:0 auto">
			<label for="proPrice" class="form-label"><span class='text-danger'>*가격</span></label>
			<input type="Number" name="proPrice" id="proPrice" value="-1" class="form-control">
		</div>
		<div class="mb-3" style="width: 20%; float:none; margin:0 auto">
			<label for="proAmount" class="form-label"><span class='text-danger'>*수량</span></label>
			<input type="Number" name="proAmount" id="proAmount" value="-1" class="form-control">
		</div>
		<div class="mb-3" style="width: 20%; float:none; margin:0 auto">
			<label for="proSavedMoney" class="form-label">적립금</label>
			<input type="text" name="proSavedMoney" id="proSavedMoney" value="0" class="form-control">
		</div>
		<div class="mb-3" style="width: 20%; float:none; margin:0 auto">
			...
			<div class="text-center"><h3>제품 상세 정보</h3></div><br>
			<div class="mb-3" style="width: 35%; float:none; margin:0 auto">
				<textarea name="proDetail" cols="30" rows="5" class="form-control"></textarea>
			</div>
			<div class="mb-3" style="width: 20%; float:none; margin:0 auto">
				<label for="youtubeAdd" class="form-label">유튜브 영상 주소(유튜브 영상은 공유->퍼가기->iframe /iframe 전부 복사해서 붙여넣기 해주세요)</label>

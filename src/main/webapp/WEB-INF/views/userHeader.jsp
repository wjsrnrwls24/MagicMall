...
<div class="container">
	...
	<div align="right">	
		<a href="#" onclick="outChk()">로그아웃</a> <a href="<c:url value='/mypage'/>">  마이페이지</a> <a href="<c:url value='/basket/main'/>">장바구니</a>
	</div><br>
	...
	<div class="container-fluid">
		...
		<ul class="navbar-nav me-auto mb-2 mb-lg-0">
			<li class="nav-item">
			 ...
			 <li class="nav-item">
			 <a href="<c:url value='/board/list'/>" class="nav-link active">
			 	마술팁 게시판
			 </a>
			 </li>
			 </ul>

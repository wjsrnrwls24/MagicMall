...
<div class="container">
	<div class="text-center"><h3>배송 주소록 등록</h3></div><br>
	<form method="post" action="<c:url value='/mypage/addressAddEx'/>" name="addressAddEx">
		<input type="hidden" id="userNo" name="userNo" value="${userNo}"/>
			<table class="table">
				<tr>
					<td class="table-secondary"><span class="text-danger">*주소지 이름</span></td>
					<td class="table-light"><input type="text" name="addName" id="addName" class="form-control"></td>
				</tr>
				<tr>
			...
			<input type="submit" value="주소지 등록" id="addressAddRequest" name="addressAddRequest" class="btn btn-outline-success"/>
			<a href="<c:url value='/mypage/address?userNo=${userNo }'/>">
